...
var HTMLposterImageURL = '<picture><img class="lazy poster" src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-original="%data%" width="%width%"></picture>';
